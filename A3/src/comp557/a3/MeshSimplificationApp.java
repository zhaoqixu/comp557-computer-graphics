...
public class MeshSimplificationApp implements SceneGraphNode, Interactor {
    ...
    public MeshSimplificationApp() {    
        ...
        EasyViewer ev = new EasyViewer("Comp 557 Mesh Simplification - Zhaoqi Xu - 260563752", this, new Dimension(400, 400), new Dimension(600, 650) );
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // draw new vertex based on the quadric error
        if ( currentHE != null  && drawHalfEdge.getValue() ) {
            currentHE.display( drawable );
            
            Vector4d v = new Vector4d();
            Matrix4d Q = new Matrix4d();
            heds.computeQuadricError(currentHE, v, Q, regularizationWeight.getValue() );
        ...
        component.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                	...
                	if ( e.isShiftDown() ) {
                		do {
                			currentHE = heds.checkTopo( regularizationWeight.getValue());
                		} while ( currentHE != null );
                	} else {
                		currentHE = heds.checkTopo( regularizationWeight.getValue());
                	}
                } else if ( e.getKeyCode() == KeyEvent.VK_G ) {
                	// TODO: Objective 5: handle G keypress to set the halfedge to the best candidate
                	currentHE = heds.pq.peek().he;
